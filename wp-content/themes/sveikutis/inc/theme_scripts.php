...
function _s_scripts() {
    ...
    wp_enqueue_style('_s-themeStyle-ionicons', get_template_directory_uri() . '/css/ionicons.min.css');
	...
	wp_enqueue_script( '_s-smooth-scroll', get_template_directory_uri() . '/js/smoothScroll.js', array(), '20151215', true );
